...
class NetworkVideoJsonAdapter(moshi: Moshi) : JsonAdapter<NetworkVideo>() {
    ...
    override fun fromJson(reader: JsonReader): NetworkVideo {
        ...
        while (reader.hasNext()) {
            when (reader.selectName(options)) {
                0 -> videoTitle = stringAdapter.fromJson(reader) ?: throw JsonDataException("Non-null value 'videoTitle' was null at ${reader.path}")
        ...
        var result = NetworkVideo(
                videoTitle = videoTitle ?: throw JsonDataException("Required property 'videoTitle' missing at ${reader.path}"),
    ...
    override fun toJson(writer: JsonWriter, value: NetworkVideo?) {
        ...
        writer.beginObject()
        writer.name("title")
        stringAdapter.toJson(writer, value.videoTitle)
